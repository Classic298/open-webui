...
_profile_image_max_data_uri_size_raw = os.getenv('PROFILE_IMAGE_MAX_DATA_URI_SIZE')
try:
    PROFILE_IMAGE_MAX_DATA_URI_SIZE = (
        int(_profile_image_max_data_uri_size_raw) if _profile_image_max_data_uri_size_raw else None
    )
except (ValueError, TypeError):
    PROFILE_IMAGE_MAX_DATA_URI_SIZE = None
