...
from open_webui.models.users import Users, User, UserNameResponse, AsyncUsers
from open_webui.models.channels import Channels, ChannelMember, AsyncChannels
...
# =============================================================================
# ASYNC MESSAGE TABLE (Phase 3: Core Model Conversion)
# =============================================================================


class AsyncMessagesTable:
    ...
    async def insert_new_message(
        ...
        await AsyncChannels.join_channel(channel_id, user_id)
...
# Async instance
AsyncMessages = AsyncMessagesTable()
